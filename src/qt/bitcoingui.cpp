                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("QuantisNET Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a QuantisNET address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and quantisnet: URIs)"));
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zQUAN"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About QuantisNET Core"), this);
    aboutAction->setStatusTip(tr("Show information about QuantisNET Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for QuantisNET"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your QuantisNET addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified QuantisNET addresses"));
    ...
    openAction->setStatusTip(tr("Open a QuantisNET: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the QuantisNET Core help message to get a list with possible QuantisNET command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("QuantisNET Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to QuantisNET network", "", count));
}
...
{
    QString strTitle = tr("QuantisNET Core"); // default title
...
/** Creates context menu, its actions, and quantisnets up all the relevant signals for mouse events. */
