                                                    ...
                                                    transactionView(0)
{
    ...
    typeWidget->addItem(tr("Received QuantisNET from zQuantisNET"), TransactionFilterProxy::TYPE(TransactionRecord::RecvFromZerocoinSpend));
    ...
    typeWidget->addItem(tr("Zerocoin Spend, Change in zQuantisNET"), TransactionFilterProxy::TYPE(TransactionRecord::ZerocoinSpend_Change_zQuantisNET));
