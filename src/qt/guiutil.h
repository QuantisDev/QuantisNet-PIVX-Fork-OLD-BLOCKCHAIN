...
/** Utility functions used by the QuantisNET Qt UI.
 */
namespace GUIUtil
{
...
// Render QuantisNET addresses in monospace font
...
// Parse "quantisnet:" URI into recipient object, return true on successful parsing
