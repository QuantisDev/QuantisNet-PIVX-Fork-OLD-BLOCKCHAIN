...
public:
    ...
    void setZQuantisNETControlLabels(int64_t nAmount, int nQuantity);
...
//    void coinControlClipboardChange();
    ...
    void on_pushButtonMintzQUAN_clicked();
    void on_pushButtonMintReset_clicked();
    void on_pushButtonSpentReset_clicked();
    void on_pushButtonSpendzQUAN_clicked();
    void on_pushButtonZQuantisNETControl_clicked();
