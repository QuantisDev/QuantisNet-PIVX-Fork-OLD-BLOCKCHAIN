...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("QuantisNET Core quantisnet-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  quantisnet-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded quantisnet transaction") + "\n" +
                               "  quantisnet-tx [options] -create [commands]   " + _("Create hex-encoded quantisnet transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded quantisnet transaction
