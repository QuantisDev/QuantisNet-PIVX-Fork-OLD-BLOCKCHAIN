...
Value stop(const Array& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "\nStop QuantisNET server.");
    // Shutdown will take long enough that the response should get back
    StartShutdown();
    return "QuantisNET server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* QuantisNET features */
        {"quantisnet", "masternode", &masternode, true, true, false},
        {"quantisnet", "listmasternodes", &listmasternodes, true, true, false},
        {"quantisnet", "getmasternodecount", &getmasternodecount, true, true, false},
        {"quantisnet", "masternodeconnect", &masternodeconnect, true, true, false},
        {"quantisnet", "masternodecurrent", &masternodecurrent, true, true, false},
        {"quantisnet", "masternodedebug", &masternodedebug, true, true, false},
        {"quantisnet", "startmasternode", &startmasternode, true, true, false},
        {"quantisnet", "createmasternodekey", &createmasternodekey, true, true, false},
        {"quantisnet", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"quantisnet", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"quantisnet", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"quantisnet", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"quantisnet", "getmasternodescores", &getmasternodescores, true, true, false},
        {"quantisnet", "mnbudget", &mnbudget, true, true, false},
        {"quantisnet", "preparebudget", &preparebudget, true, true, false},
        {"quantisnet", "submitbudget", &submitbudget, true, true, false},
        {"quantisnet", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"quantisnet", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"quantisnet", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"quantisnet", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"quantisnet", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"quantisnet", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"quantisnet", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"quantisnet", "checkbudgets", &checkbudgets, true, true, false},
        {"quantisnet", "mnsync", &mnsync, true, true, false},
        {"quantisnet", "spork", &spork, true, true, false},
        {"quantisnet", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"quantisnet", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use quantisnetd, or the -server option to quantisnet-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> quantisnet-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:7772/\n";
}
