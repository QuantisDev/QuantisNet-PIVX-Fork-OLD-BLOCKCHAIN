Contributing to QuantisNET Core
============================

The QuantisNET Core project operates an open contributor model where anyone is
...
The following applies to code changes to the QuantisNET Core project, and is not to be
confused with overall QuantisNET Network Protocol consensus changes.

Whether a pull request is merged into QuantisNET Core rests with the project merge
...
Patches that change QuantisNET consensus rules are considerably more involved than
...
Where a patch set proposes to change the QuantisNET consensus, it must have been
...
The project leader is the release manager for each QuantisNET Core release.
