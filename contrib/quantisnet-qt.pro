...
HEADERS += src/activemasternode.h \
           ...
           src/walletdb.h \
           src/compat/sanity.h \
           src/config/quantisnet-config.h \
           src/crypto/common.h \
...
SOURCES += src/activemasternode.cpp \
           ...
           src/obfuscation.cpp \
           src/quantisnet-cli.cpp \
           src/quantisnet-tx.cpp \
           src/quantisnet.cpp \
           src/db.cpp \
           ...
           src/qt/quantisnet.cpp \
           src/qt/quantisnetstrings.cpp \
...
RESOURCES += src/qt/quantisnet.qrc src/qt/quantisnet_locale.qrc

TRANSLATIONS += src/qt/locale/quantisnet_bg.ts \
                src/qt/locale/quantisnet_de.ts \
                src/qt/locale/quantisnet_en.ts \
                src/qt/locale/quantisnet_es.ts \
                src/qt/locale/quantisnet_fi.ts \
                src/qt/locale/quantisnet_fr.ts \
                src/qt/locale/quantisnet_it.ts \
                src/qt/locale/quantisnet_ja.ts \
                src/qt/locale/quantisnet_pl.ts \
                src/qt/locale/quantisnet_pt.ts \
                src/qt/locale/quantisnet_ru.ts \
                src/qt/locale/quantisnet_sk.ts \
                src/qt/locale/quantisnet_sv.ts \
                src/qt/locale/quantisnet_vi.ts \
                src/qt/locale/quantisnet_zh_CN.ts \
                src/qt/locale/quantisnet_zh_TW.ts
