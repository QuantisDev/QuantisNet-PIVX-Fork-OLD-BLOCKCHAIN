...
In order to support loading of multiple wallets in quantisnet-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is quantisnet.cpp.
...
Changes to quantisnet.cpp
----------------------
quantisnet.cpp is the entry point into quantisnet-qt, and as such, will require some minor modifications to provide hooks for
